...
export default function SeccaoVerde() {
    return (
        <>
            <h1 className='text-center py-8 text-2xl md:text-3xl lg:text-4xl bg-white to-green-500 font-extrabold text-yellow-500'>PROPOSTAS</h1>
                ...
                <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-start text-[#003366]">
                    ...
                    >
                        <Image
                            ...
                            width={400}
                            height={300}
                            className="rounded-xl shadow-2xl mx-auto lg:mt-28 lg:py-0 py-4"
                        />
                    </motion.div>
                    {/* Texto */}
                    <motion.div
                    ...
                    >
                        <div>
                            <h2 className="text-1xl md:text-2xl lg:text-3xl font-extrabold text-yellow-500">
                                PLANEJAMENTO URBANÍSTICO
                            </h2>
                            <p className="text-sm md:text-base lg:text-lg mt-4 text-[#003366]">
